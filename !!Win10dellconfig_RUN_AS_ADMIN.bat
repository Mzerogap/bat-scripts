...
if exist "C:\Program Files (x86)\Dell\CommandUpdate\DellCommandUpdate.exe" (start "" "C:\Program Files (x86)\Dell\CommandUpdate\DellCommandUpdate.exe") else (start "" "\\sfo-fs-01\public\software\dell\Systems-Management_Application_X79N4_WN32_2.3.1_A00_01.EXE" /s /f) & pause & (start "" "C:\Program Files (x86)\Dell\CommandUpdate\DellCommandUpdate.exe")
)
...
start "" \\sfo-fs-01\public\software\logitech\unifying250.exe /S
::pause
echo install chrome
start "" "\\sfo-fs-01\public\software\chrome\ChromeSetup.exe"
::pause
echo cisco VPN
start "" /wait /b "\\sfo-fs-01\public\software\Cisco\anyconnect-win-4.4.03034-core-vpn-predeploy-k9.msi" /qb
pause
echo Box Edit
start "" /wait /b "\\sfohyp01\itsoftware\box\Box Edit\BoxToolsInstaller-AdminInstall.msi" /qb
pause
...
::echo box sync
::ping localhost -n 20
::start "" /wait /b "\\sfohyp01\itsoftware\box\Box Sync\BoxSyncSetupLTS.msi" /qb 
::pause
echo edi notepad. make sure to install express not professional version
start "" /wait /b \\sfo-fs-01\public\software\EDI\EDINotepad8_Setup.exe
pause
::echo solarwinds
::start "" /wait /b \\sfo-fs-01\public\software\GFI\AGENT_PREMIER_NUTRITION_EMERYVILLE_SEP_V10_5_12_RW\AGENT_390616_V10_5_12_RW.EXE
::pause
echo netsuite odbc drivers do not press 'skip' about 4 steps in, hit next instead of that to copy the proper settings.
start "" /wait /b \\sfo-fs-01\public\software\ODBC\NetSuiteODBCDrivers_Windows\NetSuiteODBCDrivers_Windows32bit.exe
::start "" /wait /b "\\sfo-fs-01\public\software\intel\SSD drive optimizer\Intel SSD Toolbox - v3.4.0.exe" /S
::pause
::start "" /wait /b \\sfo-fs-01\public\software\7Zip\7z1604-x64.msi /qb
::pause
echo LAPS client
start "" /wait /b \\sfohyp01\itsoftware\LAPS\LAPS.x64.msi /qb
::pause
echo tableau reader
::start "" /wait /b \\sfo-fs-01\public\software\Tableau\TableauReader-64bit.exe /q:a /c:"setup /qr"
start "" /wait /b \\sfo-fs-01\public\software\Tableau\TableauReader-64bit.exe /passive /norestart ACCEPTEULA=1 
::pause
cls
echo uninstall Microsoft Office Desktop Apps if present
::pause
echo office 2016
::start "" /wait /b \\sfohyp01\itsoftware\Non_MS_DHCP_Hotfix\InstallHotfix.bat
::start "" \\sfohyp01\itsoftware\Office2016\Office_migration.bat
\\sfohyp01\itsoftware\Office2016\O365\setup.exe /configure \\sfohyp01\itsoftware\Office2016\O365\configuration.xml
::pause
::start "" /wait /b "\\sfohyp01\itsoftware\box\Box for Office\Visual Studio 2010 Tools for Office Runtime.exe"
::pause
::start "" /wait /b "\\sfohyp01\itsoftware\box\Box for Office\BoxForOffice.msi" /qb 
::pause
echo webex desktop app
start "" /wait /b "\\sfo-fs-01\public\software\webex\webexapp.msi" /qb
::pause
echo bigfix client
start "" /wait \\sfohyp01\itsoftware\BigFix\BigFixAgent.msi /qb
::pause
::echo webex productivity tools
::ping localhost -n 10
::start "" /wait /b "\\sfo-fs-01\public\software\webex\WebEx Productivity Tools - ptools.msi" /qb
::pause
::echo spark
::start "" /wait /b "\\sfo-fs-01\public\software\Cisco\CiscoSpark_x86.msi" /qb
::pause
echo solarwinds
start "" /b "\\sfohyp01\Public\software\SLW\AGENT_PREMIER_NUTRITION_TEAM_VIEWER_CLIENTS_V10_7_10_RW\AGENT_568636_V10_7_10_RW.EXE"
::pause
echo symantec
start "" /b "\\sfohyp01\itsoftware\PNCSEPInstall\symantec_install.bat"
::pause
...
echo : "\\sfohyp01\Public\software\!new_machine_deploy\!!Onedrive_Box_drive_Mig_RUN_AS_USER.bat"
